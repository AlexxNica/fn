...
func (m *metricds) GetApp(ctx context.Context, appID string) (*models.App, error) {
	span, ctx := opentracing.StartSpanFromContext(ctx, "ds_get_app")
	defer span.Finish()
	return m.ds.GetApp(ctx, appID)
}
...
func (m *metricds) RemoveRoute(ctx context.Context, appID, routePath string) error {
...
func (m *metricds) GetCall(ctx context.Context, appID, callID string) (*models.Call, error) {
	span, ctx := opentracing.StartSpanFromContext(ctx, "ds_get_call")
	defer span.Finish()
	return m.ds.GetCall(ctx, appID, callID)
}
...
func (m *metricds) GetLog(ctx context.Context, appID, callID string) (io.Reader, error) {
	span, ctx := opentracing.StartSpanFromContext(ctx, "ds_get_log")
	defer span.Finish()
	return m.ds.GetLog(ctx, appID, callID)
}
